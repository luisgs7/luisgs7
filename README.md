...
### Skills: Python, Docker, Django, MySQL/SQL, Git/Github, Linux, Pandas 
 ...
 - <a href="https://github.com/luisgs7/expenses-api">Expenses API(Em desenvolvimento)</a>: projeto de uma API para gerenciamento de despesas pessoais, desenvolvido em Python, Django e Django Rest Framework, que no futuro planejo desenvolver um app mobile para se conectar com esta API, para que seja possível utilizar este app diariamente para controle das minhas finanças pessoais.
